...
export class ImageDialogDirective {
  ...
  constructor(
    private elementRef: ElementRef<HTMLImageElement | IImageElementProvider>,
  ...
  private setImage(image: string | IImageLike | null): IImageLike | null {
    var wasAnImageElementProvided = image !== null && image !== undefined && image !== '';
    if (wasAnImageElementProvided == false) {
      var isDirectiveOnAnImageElement = this.elementRef.nativeElement.tagName === 'IMG';
