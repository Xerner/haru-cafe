...
export const MENU_ITEMS: IMenuItem[] = [
  ...
  },
  {
    ...
    price: 10.50,
    imageUrl: "images/menu-items/9-in-sweet-potato-mouse-pizza.jpg",
    categories: [Category.Food, Category.MiniPizza],
    isFavorite: true,
    size: Size["9\""],
  },
  ...
  },
  {
    ...
    imageUrl: "images/menu-items/fresh-fruit-cream-sandwich.jpg",
    price: 5.90,
  ...
  },
  {
    ...
    price: 3.50,
    imageUrl: "images/menu-items/k-coffee.jpg",
    categories: [Category.Drink, Category.Hot, Category.Coffee],
    size: Size["10oz"],
  },
  {
  ...
  //#region iced non coffee
  {
    name: "Peach Iced Tea",
    price: 5.00,
    imageUrl: "images/menu-items/peach-iced-tea.jpg",
  ...
  },
  {
    ...
    price: 7.00,
    imageUrl: "images/menu-items/iced-fall-pumpkin-spice-latte.png",
    categories: [Category.Drink, Category.Cold, Category.Coffee, Category.Seasonal, Category.Specials],
    size: Size["20oz"],
  },
  {
  ...
  },
  {
    ...
    price: 6.50,
    imageUrl: "images/menu-items/moe-moe-sweet-mint-beam.jpg",
    categories: [Category.Drink, Category.Cold, Category.NonCoffee, Category.Anime, Category.Specials],
    size: Size["20oz"],
  },
  {
